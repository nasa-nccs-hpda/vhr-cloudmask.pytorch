...
#]
scene_paths = glob('/explore/nobackup/projects/above/misc/ABoVE_Shrubs/srlite/002m_old/*-sr-02m.tif')
ortho_subimage_cloud_dir = '/explore/nobackup/projects/above/misc/ABoVE_Shrubs/cloudmask/omni_cloudmask/002m_old'
